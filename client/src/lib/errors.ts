...
const ar: Record<string, string> = {
  ...
  provider_model_required: 'أدخل اسم النموذج.',
  ...
  private_network_url_not_allowed: 'لا يُسمح بالوصول إلى عناوين الشبكات الخاصة.',
...
const en: Record<string, string> = {
  ...
  provider_model_required: 'Enter a model name.',
  ...
  private_network_url_not_allowed: 'Private network addresses are not allowed.',
